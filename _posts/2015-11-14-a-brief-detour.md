...
date: 2015-11-14
ogimage: "20151113-btozier-alien-scape-1.jpg"
---
...
{% include _figures.html
  base_image_filename="20151113-btozier-alien-scape-1.jpg"
  title="Alien Scape 1"
  alt="Amorphic glowing orange blobs with purple lines through it over a dark bluish-black background"
  caption="Orange blobs and purple lines"
%}

{% include _figures.html
  base_image_filename="20151113-btozier-alien-scape-2.jpg"
  title="Alien Scape 2"
  alt="Glowing orange and yellow blobs with hints of purple in a light blueish green background"
  caption="Orange and purple blobs and green-blue lines"
%}

{% include _figures.html
  base_image_filename="20151114-btozier-alien-scape-3.jpg"
  title="Alien Scape 3"
  alt="Royal blue background with dark green squiggly lines through it. There are few glowing yellow blobs."
  caption="Green pathways in blue"
%}

{% include _figures.html
  base_image_filename="20151114-btozier-alien-scape-4.jpg"
  title="Alien Scape 4"
  alt="Overall blue with bright purple angular lines and blobs. A single yellow dot glows in the upper left"
  caption="Dots and lines"
%}

{% include _figures.html
  base_image_filename="20151114-btozier-alien-scape-5.jpg"
  title="Alien Scape 5"
  alt="Dark blue background with bright yellow smudge and random other lighter blue dots"
  caption="Shadowed planetary view"
%}

[^digital]: A completely digital workflow is fiddly and frustrating and enervating and expensive, but in a different way. Maybe one day I'll put together a pros-and-cons table for each type, but I doubt I will. Discussions about film-*vs*-digital are as interesting as the most uninteresting thing.
